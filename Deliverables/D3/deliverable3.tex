...
\hline
14/08/13 & 0.49 & Added Manual Tests and Unit Tests to Section 2.1.1 & Ghislain Ledoux \\
\hline
\end{tabular}
\end{center}
\end{table}
...
\paragraph{Map Scrolling.} Test that the map display moves by the correct distance and direction when dragged by the mouse. Test that the edges of the map cannot be scrolled beyond the center of the screen. \emph{Manual test.}
