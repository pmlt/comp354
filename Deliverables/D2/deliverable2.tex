...
\centering
\includegraphics[scale=0.5]{diagrams/activity-diagram.eps}
\end{figure}
...
\subsection{Subsystem Interfaces Specifications} % Status: Work in Progress
...
\subsection{Subsystems} % Status: Work in Progress
